...
public class GuestCheckReservesmal extends javax.swing.JPanel {
    ...
    public void insertarReservas() {
        ...
        List<Reserva> misReservas = JavaBNB.getInmuebles().stream()
                .flatMap(inmueble -> inmueble.getReservas().stream())
                .filter(reserva -> reserva.getParticular().equals(((Particular) Sesion.user)))
